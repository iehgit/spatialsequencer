...
namespace spatial_midi {
    ...
    private:
        ...
        [[nodiscard]] snd_seq_real_time_t scheduled_time_locked(TimePoint deadline) const;
    ...
    private:
        ...
        [[nodiscard]] TimePoint event_timestamp(const snd_seq_event_t &event, TimePoint fallback) const noexcept;
